...
#define MYY_IOW(nr, type) _IOW(MYY_IOCTL_BASE, nr, type)

#define MYY_IOCTL_VPU_WRITE_REGISTERS      MYY_IO(0x1)
...
#define MYY_IOCTL_VPU_COPY_REGISTERS       MYY_IOW(0x5, uint32_t)
